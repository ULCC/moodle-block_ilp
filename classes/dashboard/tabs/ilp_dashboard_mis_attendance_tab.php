...
class ilp_dashboard_mis_attendance_tab  extends ilp_dashboard_tab {
	...
	function display_name()	{
		return	get_string('ilp_dashboard_mis_attendance_tab_name','block_ilp');
	}
	 ...
	 */
	 function language_strings(&$string) {
        $string['ilp_dashboard_mis_attendance_tab'] 					= 'ATTENDANCE MIS PLUGINS';
        $string['ilp_dashboard_mis_attendance_tab_name'] 				= 'Attendance';
