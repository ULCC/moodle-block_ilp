...
$reportlist[] = array(
			...
			'fieldlist' => array(
				...
				array(
					'type' => 'textarea',
					'label' => 'Is there anything that may get in the way of your studies/learning? Is there anything that could affect your studies? For example: responsibilities including childcare, difficulties with money, housing, immigration, money &hellip;',
					'description' => 'generic description',
					'req' => 0
				),
				array(
				...
				array(
					'type' => 'textarea',
					'label' => 'What languages do you speak? What is your first language?',
					'description' => 'generic description',
					'req' => 0
				),
				array(
					'type' => 'textarea',
					'label' => 'Is there anything you think you will need help with this year? (for example: English, Maths, Dyslexia, study skills &hellip;)',
					'description' => 'generic description',
					'req' => 0
				)
			)
