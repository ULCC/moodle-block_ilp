...
class ilp_dashboard_mis_quals_tab  extends ilp_dashboard_tab {
	...
	function display_name()	{
		return	get_string('ilp_dashboard_mis_quals_tab_name','block_ilp');
	}
				...
				foreach ($mis_plugins as $plugin_file) {
					...
					if (file_exists($plugins.'/'.$plugin_file.".php")) {
					    ...
					    require_once($plugins.'/'.$plugin_file.".php");
                                            ...
                                            if ($plugin_file::plugin_type() == 'quals') {
	 ...
	 */
	 static function language_strings(&$string) {
        $string['ilp_dashboard_mis_quals_tab'] 					= 'Quals PLUGINS';
        $string['ilp_dashboard_mis_quals_tab_name'] 				= 'Qualifications';
